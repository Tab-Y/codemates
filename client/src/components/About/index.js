          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
              ...
              <div class="carousel-inner carousel-fade">
                <div class="carousel-item active">
                  <img src="./assets/images/CarouselPic1.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption" style="background-color: #051923;">
                    <h1>Taber Youmans</h1>
                ...
                <div class="carousel-item">
                  <img src="./assets/images/CarouselPic2.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption" style="background-color: #051923;">
                ...
                <div class="carousel-item">
                  <img src="./assets/images/CarouselPic3.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption" style="background-color: #051923;">
                ...
                <div class="carousel-item">
                  <img src="./assets/images/CarouselPic4.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption" style="background-color: #051923;">
